...
class UT_ToolMenu2 extends StatefulWidget {
  ...
  @override
  State<UT_ToolMenu2> createState() => _UT_ToolMenuState();
}

class _UT_ToolMenuState extends State<UT_ToolMenu2> {
  ...
  Widget productTile(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: Image.asset(
          'assets/images/vegetable-names.jpg',
          height: 60,
          width: 60,
          fit: BoxFit.cover,
        ),
